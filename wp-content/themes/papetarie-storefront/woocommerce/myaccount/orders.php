      ...
      <div class="pap-account-orders-list-table">
        ...
        <?php foreach ($customer_orders->orders as $customer_order) : ?>
          ...
          <div class="pap-account-orders-list-table__row">
            ...
            <span class="pap-account-orders-list-table__date"><?php echo esc_html($order->get_date_created() ? wp_date('j M Y', $order->get_date_created()->getTimestamp()) : __('Nespecificat', 'papetarie-storefront')); ?></span>
